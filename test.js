( () => {
    ...
    if (window.PokiSDK = {
        ...
        isAdBlocked: () => {}
        ,
        getUser: r.withPromise("getUser"),
        getToken: r.withPromise("getToken"),
        login: r.withPromise("login")
    },
    ...
    !o && !t)
        try {
            ...
            window.PokiSDK.measure = (e, a, n) => {
                ...
                ))) : console.warn(`%cPOKI:%c measure() event not allowed: ${e}-${a}-${n}`, "font-weight: bold", "")
            }
            ,
    ...
    const a = ( () => {
        const r = window.pokiSDKVersion || e("ab") || "b7fa615b71506c168476d0bb30d15f35ebafe1c9";
